            ...
            try {
                if (1 == a && bmak["mme_cnt"] < bmak["mme_cnt_lmt"] || 1 != a && bmak["mduce_cnt"] < bmak["mduce_cnt_lmt"]) {
                    ...
                    var r = bmak.gf (m),
                        ...
                        // c= mouseevent_count,a=action_type,i=(now_time-script_start_time),n=x-coordinate,o=y-coordinate,
                    ...
                    // push only if event.isTrusted
                    void 0 !== e["isTrusted"] && !1 === e["isTrusted"] && (c += ",it0"), c += ";", bmak["me_vel"] = bmak["me_vel"] + bmak["me_cnt"] + a + i + n + o, bmak["mact"] = bmak["mact"] + c, bmak["ta"] += i
                }
                1 == a ? bmak["mme_cnt"]++ : bmak["mduce_cnt"]++, bmak["me_cnt"]++, 
                // right clicked
                bmak["js_post"] && 3 == a && (bmak["aj_type"] = 1, bmak.bpd (), bmak.pd (!0), bmak["ce_js_post"] = 1)
            } catch (t) {}
        },
        x2: function() {
            var t = bmak["ff"],
            ...
            try {
                ...
                if (bmak["ke_cnt"] < bmak["ke_cnt_lmt"] && e) {
                    ...
                    var m = e["charCode"],
                        ...
                        // The focussed element name/id in Numbers using charCodeAt.
                        s = bmak.gf (null),
                        l = 0;
                    // n = keycode or -2,-3 or -4
                    ...
                    if (0 == bmak.isIgn (n)) {
                        // u = key_count,a=action_type,k=(now_time-script_start_time),n=key_code,l=0,d=computation,s=focussed_element
        ...
        lvc: function(t) {
            ...
            try {
                if (bmak["vc_cnt"] < bmak["vc_cnt_lmt"]) {
                    var a = bmak.get_cf_date () - bmak["start_ts"],
                    // e= t=type,a=(now_time-script_start_time),
                        e = t + "," + a + ";";
...
if (function(t) {
        ...
        t["fpcf"] = a, a["sf4"] = function() {
            ...
            try {
                ...
                var e = -1;
                // * CANVAS FINGERPRINTING ON desktop users
                if (!a.sf4 ()) {
            ...
            var t = 200,
                e = bmak.get_cf_date (),
                n = [];
                 // * DESKTOP FINGERPRINTING ON desktop users
            if (!a.sf4 ()) {
                ...
                // * CREATE SAMPLE TEXT FOR EACH FONT
